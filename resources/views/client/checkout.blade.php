    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7 ftco-animate">
                <form action="{{route('postcheckout')}}" class="billing-form" method="POST" id="checkout-form">
                    @csrf
                ...
                <div class="row mt-5 pt-3">
                    <div class="col-md-12 d-flex mb-5">
                        <div class="cart-detail cart-total p-3 p-md-4">
                            ...
                            <p class="d-flex">
                                <span>Subtotal</span>
                                <span>{{Session::get('cart')->totalPrice}} din</span>
                            </p>
                            <p class="d-flex">
                                <span>Delivery</span>
                            ...
                            <p class="d-flex total-price">
                                <span>Total</span>
                                <span>{{Session::get('cart')->totalPrice + 250}}</span>
                            </p>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script src="https://js.stripe.com/v3/"></script>
    <script src="{{asset('public/src/js/checkout.js')}}"></script>
    <script>
