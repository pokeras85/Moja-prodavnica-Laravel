            ...
            <div class="col-md-12 ftco-animate">
                <div class="cart-list">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            <td class="product-remove"><a href="{{route('RemoveItem',$product['product_id'])}}"><span class="ion-ios-close"></span></a></td>

                            <td class="image-prod"><div class="img" style="background-image:url(public/storage/ProductImages/{{$product['product_image']}});"></div></td>
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{route('UpdateQty', $product['product_id'])}}">
                                @csrf
                                <td class="quantity">
        ...
        <div class="row justify-content-end">
            ...
            <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                <div class="cart-total mb-3">
                    ...
                    <p class="d-flex">
                        <span>Subtotal</span>
                        <span>{{Session::has('cart')?Session::get('cart')->totalPrice:0}} dinara</span>
                    </p>
                    <p class="d-flex">
                        <span>Delivery</span>
                    ...
                    <p class="d-flex total-price">
                        <span>Total</span>
                        <span>{{Session::has('cart')?Session::get('cart')->totalPrice+250:0}} din</span>>
                </div>
