...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="#"><img src="<?php echo e(asset('public/Backend/images/2h_.png')); ?>" class="mr-2" alt="logo"/></a>
        </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
                        <img src="<?php echo e(asset('public/Backend/images/logo_2H_tech.png')); ?>" alt="profile"/>
                    </a>
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('/admin/category/create')); ?>">Add category</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('/admin/product/create')); ?>">Add products</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('/admin/slider/create')); ?>">Add slider</a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/admin/categories')); ?>">Categories</a></li>
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/admin/products')); ?>">Products</a></li>
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/admin/sliders')); ?>">Sliders</a></li>
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(URL::to('/admin/orders')); ?>">Orders</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
...
<?php /**PATH C:\wamp64\www\E-commerce\MojaProdavnica\resources\views/admin/index.blade.php ENDPATH**/ ?>