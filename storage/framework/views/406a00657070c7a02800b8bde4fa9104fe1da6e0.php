    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7 ftco-animate">
                <form action="<?php echo e(route('postcheckout')); ?>" class="billing-form" method="POST" id="checkout-form">
                    <?php echo csrf_field(); ?>
...
<div class="alert alert-danger">
    ...
    <?php echo e(Session::put('error',null)); ?>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="" name="card_name" id="card-name">
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col-md-12">
                    ...
                    <input type="submit" class="btn btn-primary py-3 px-4" value="Buy now">
                </form><!-- END -->
            </div>
            <div class="col-xl-5">
                <div class="row mt-5 pt-3">
                    <div class="col-md-12 d-flex mb-5">
                        <div class="cart-detail cart-total p-3 p-md-4">
                            ...
                            <p class="d-flex">
                                <span>Subtotal</span>
                                <span><?php echo e(Session::get('cart')->totalPrice); ?> din</span>
                            </p>
                            <p class="d-flex">
                                <span>Delivery</span>
                            ...
                            <p class="d-flex total-price">
                                <span>Total</span>
                                <span><?php echo e(Session::get('cart')->totalPrice + 250); ?></span>
                            </p>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    <script src="https://js.stripe.com/v3/"></script>
    <script src="<?php echo e(asset('public/src/js/checkout.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\wamp64\www\E-commerce\MojaProdavnica\resources\views/client/checkout.blade.php ENDPATH**/ ?>