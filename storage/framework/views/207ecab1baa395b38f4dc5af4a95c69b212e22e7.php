            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    ...
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text"><?php echo e(Session::has('client')?Session::get('client')->email:'Youremal@email.com'); ?> </span>
                    </div>
...
<?php if(Session::has('success')): ?>
    <div class="container alert-success">   <?php echo e(Session::get('success')); ?> </div>
<?php endif; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    ...
                    <li><a href="<?php echo e(URL::to('/shop/'.$category->id)); ?>"><?php echo e($category->name); ?></a></li>
...
<?php /**PATH C:\wamp64\www\E-commerce\MojaProdavnica\resources\views/client/shop.blade.php ENDPATH**/ ?>