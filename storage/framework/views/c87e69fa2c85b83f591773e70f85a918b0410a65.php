            ...
            <div class="col-md-12 ftco-animate">
                <div class="cart-list">
                    <table class="table">
                        ...
                        <tr class="text-center">
                            <td class="product-remove"><a href="<?php echo e(route('RemoveItem',$product['product_id'])); ?>"><span class="ion-ios-close"></span></a></td>

                            <td class="image-prod"><div class="img" style="background-image:url(public/storage/ProductImages/<?php echo e($product['product_image']); ?>);"></div></td>
                            ...
                            <td class="price"><?php echo e($product['product_price']); ?></td>
                            <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('UpdateQty', $product['product_id'])); ?>">
                                <?php echo csrf_field(); ?>
                                <td class="quantity">
                                    <div class="input-group mb-3">
                                        <input type="number" name="quantity" class="quantity form-control input-number" value="<?php echo e($product['Qty']); ?>" min="1" max="100">
                            ...
                            <td class="total"><?php echo e($product['product_price']*$product['Qty']); ?></td>
                        </tr><!-- END TR-->
...
<?php endif; ?>
        ...
        <div class="row justify-content-end">
            <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                ...
                <p><a href="<?php echo e(URL::to('/checkout')); ?>" class="btn btn-primary py-3 px-4">Apply Coupon</a></p>
            </div>
            <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                <div class="cart-total mb-3">
            ...
            <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                <div class="cart-total mb-3">
                    ...
                    <p class="d-flex">
                        <span>Subtotal</span>
                        <span><?php echo e(Session::has('cart')?Session::get('cart')->totalPrice:0); ?> dinara</span>
                    </p>
                    <p class="d-flex">
                        <span>Delivery</span>
                        <span>250 dinara</span>
                    </p>
                    <p class="d-flex">
                        <span>Discount</span>
                        <span>0</span>
                    ...
                    <p class="d-flex total-price">
                        <span>Total</span>
                        <span><?php echo e(Session::has('cart')?Session::get('cart')->totalPrice+250:0); ?> din</span>>
                </div>
...
<?php /**PATH C:\wamp64\www\E-commerce\MojaProdavnica\resources\views/client/cart.blade.php ENDPATH**/ ?>